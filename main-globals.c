...
/**
 * free_glob_v -a function that fress the global variables.
 */
...
/**
 * start_glob_v - a function that initializes the global variables.
 *
 * @fd: file descriptor
 * Return: no return.
 */
...
/**
 * checkinput - a function that checks if the file exists
